...
export default function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <div className="group relative flex flex-col rounded-2xl border border-[var(--gray)] bg-[var(--white)] overflow-hidden hover:shadow-[0_12px_30px_-12px_rgba(6,59,24,0.25)] hover:-translate-y-1 transition-all duration-300">
